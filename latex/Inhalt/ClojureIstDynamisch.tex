...
\begin{itemize}
 ...
 \item Dynamisches Aufrufen einer \Code{eval} Methode
  \begin{itemize}
    \item \Code{eval} ist meist so implementiert, dass Code als String der Methode übergeben
...
Virtual Machine} und der \Fachbegriff{Microsoft CLR}[\cite{ClojureCLR}] läuft.
Sie ist als universelle Programmiersprache ausgelegt, die die Zugänglichkeit
...
Sprache dynamisch, da alle Clojure Funktionen zur Laufzeit verfügbar sind. 
...
können, um direkt mit den Ergebnissen weiter zu arbeiten.
