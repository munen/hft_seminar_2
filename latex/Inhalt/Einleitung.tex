...
Die vorliegende Arbeit ist die schriftliche Ausarbeitung zum Thema
\NeuerBegriff{Clojure}. In ihr wird Clojure gegenüber LISP abgegrenzt und über
die Vorteile dynamischer und funktionalier Programmierung im Gegenzug zu
konvetiell strukturierter Programmierung besprochen.
...
\begin{itemize}
    \item 
        ...
        Neue Begriffe sind für den schnellen Überblick gesondert im Textbild
        hervorgehoben.
    \item 
    ...
    \item 
        ...
        größeren Code-Versatzstücken wird jedoch volles Syntax-Highlighting
        verwendet.
    \item 
