...
Clojure baut auf dem Stack der \Fachbegriff{Java Virtual Machine} auf. Dies bietet
...
Syntax steht im Jargon File\cite{PG2} eine alternative Beschreibung des Akrynyms
LISP: \Fachbegriff{Lots of Irritating Superfluous Parantheses}. Auch hier räumt Clojure auf,
...
schnell - es ist etwa 3-5x langsamer als Java. Verglichen mit anderen
...
sitzen zu bleiben.  Selbst Microsoft sieht diesen Trend wachsen und liess erst
Python auf die .NET Platform, nun entwickeln sie eine eigene funktionale
Programmiersprache F\#, die unter Entwicklern im Windows Umfeld zusehens
