...
S-Expressions fusst[\cite{wiki3}] (wie sie etwa in Common LISP)
...
Akrynyms LISP: \Fachbegriff{Lots of Irritating Superfluous Parantheses}. Auch
hier räumt Clojure auf, indem es ähnlich wie Ruby mit unnötigen Klammern spart.
Die Syntax wird um Vectors und Maps
