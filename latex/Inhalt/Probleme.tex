...
die Resource \Code{sum} dagegen abgesichert werden. Dafür werden häufig \NeuerBegriff{Locks} eingesetzt. Bei einem Lock wird ein Codebereich gesichert, indem nur einem Thread dazu Zutritt gewährt wird. 
